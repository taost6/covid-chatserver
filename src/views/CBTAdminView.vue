...
import { cbtApi, type CBTAdminToken } from '@/utils/cbtApi';
...
const headers = [
  ...
  { title: '状態', key: 'is_active', width: '90px' },
  { title: '進捗', key: 'progress', width: '160px' },
  { title: '最終アクセス', key: 'last_seen_at', width: '160px' },

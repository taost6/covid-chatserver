...
ユーザー（保健師）が会話を終了しようとしていると判断した場合、例えば『ご協力ありがとうございました』のような感謝の言葉で締めくくった場合は、一言応答してください。"""
...
聞き取りが十分に行えたと判断した場合は、最後の質問への患者の回答を聞き終えてから、「ご協力ありがとうございました」のような感謝の言葉と共に end_conversation_and_start_debriefing ツールを呼び出して会話を終了してください。質問と終了を同時に行わないでください。"""
